...
const Offering = () => {
  ...
  return (
    <section id="offering" className="py-16 bg-white">
      <div className="container px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center">
            <img 
              src="/lovable-uploads/fdf3b767-fc30-44e3-ae82-d41c54820d83.png" 
              alt="Sunshine Club Mascot" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <Card key={index} className={`border ${plan.highlight ? 'border-stb-yellow shadow-xl' : 'border-gray-200'} relative overflow-hidden`}>
              {plan.highlight && (
                <div className="absolute top-0 right-0 bg-stb-yellow text-black font-bold px-3 py-1 rounded-bl-md">
                  BEST VALUE
                </div>
              )}
              {plan.timer && (
                <div className="absolute top-0 left-0 right-0 bg-stb-pink text-white text-center py-1 text-sm">
