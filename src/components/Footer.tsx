      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-white/90 font-handwritten text-xl">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  <a href="#" className="text-white/80 hover:text-white transition-colors flex items-center gap-2 group">
          ...
          <div>
            ...
            <p className="text-white/80 mb-4 font-handwritten text-lg">Get exclusive travel drops and tips!</p>
        ...
        <div className="mt-8 text-center p-5 bg-white/10 rounded-3xl backdrop-blur-sm border border-white/20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80">...and unlock our secret travel hack guide!</p>
