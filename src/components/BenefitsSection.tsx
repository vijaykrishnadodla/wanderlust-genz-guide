      ...
      <div className="container px-4 md:px-6 max-w-6xl mx-auto text-center">
        <div className="mb-12">
          ...
          <div className="relative">
            ...
            <span className="absolute -top-6 right-1/4 text-yellow-300 animate-float">✨</span>
            <span className="absolute -bottom-4 left-1/4 text-yellow-400 animate-bounce-subtle">⭐</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="content-card">
            ...
            <p className="text-gray-600">
              Our members save an average of $200/week when travelling with our exclusive student deals
            </p>
          </div>
