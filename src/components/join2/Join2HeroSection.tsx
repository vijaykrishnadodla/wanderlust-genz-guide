...
const bullets = [
  ...
  "Personalized itinerary for your trip, budget & style",
  "Save $20–$300/week on transport, attractions & food",
  "Student-verified. Cancel anytime.",
];

const Join2HeroSection = () => {
  return (
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-base sm:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 mb-8">
              Student Travel Buddy is a <strong className="text-primary">$20/year</strong> student-verified membership that helps you travel abroad with confidence — real discounts, a personal trip plan, and support when you need it.
            </p>
            ...
            <p className="text-sm text-muted-foreground flex items-center gap-1 justify-center lg:justify-start">
              <Star className="h-4 w-4 text-primary fill-primary" /> Trusted by students traveling across Europe, the UK & beyond
            </p>
          </div>
...
export default Join2HeroSection;
