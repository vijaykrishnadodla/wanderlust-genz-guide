...
const SunshineClub = () => {
  ...
  return <section id="sunshine-club" className="py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#FDE1D3]/80 to-white">
        ...
        <div className="absolute inset-0 opacity-5">
          {[...Array(8)].map((_, i) => (
            <div 
              key={i} 
              className="absolute rounded-full bg-gradient-to-br from-[#FFDD6C] to-[#F97316] opacity-30 animate-slow-pulse" 
              style={{
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="text-center mb-10">
          <div className="inline-block bg-[#FEC6A1] px-6 py-2 rounded-lg transform -rotate-1 mb-4 flex flex-col items-center justify-center shadow-lg">
            ...
            <div className="flex items-center justify-center">
              <Sun className="h-6 w-6 text-[#F97316] mr-2 animate-spin" style={{ animationDuration: '30s' }} />
        ...
        {/* Enhanced Inspirational Sun Elements with natural sun rays */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-12">
          {/* First sun */}
          <div className="relative w-32 h-32 md:w-40 md:h-40">
            <div className="absolute inset-0 sun-rays"></div>
            <div className="absolute inset-0 long-rays"></div>
            <div className="sunshine-gradient rounded-full h-full w-full flex items-center justify-center p-4 shadow-lg transform rotate-2 sun-glow">
          ...
          <div className="relative w-36 h-36 md:w-48 md:h-48">
            <div className="absolute inset-0 sun-rays"></div>
            <div className="absolute inset-0 long-rays"></div>
            <div className="absolute inset-0 sun-burst"></div>
            <div className="sunshine-gradient rounded-full h-full w-full flex items-center justify-center p-4 shadow-lg transform rotate-3 sun-glow">
        ...
        <div className="max-w-3xl mx-auto mb-12 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden relative">
          <div className="absolute -top-2 -right-2 relative">
            <div className="sunshine-gradient rounded-full w-16 h-16 flex items-center justify-center z-10">
              <div className="absolute inset-0 sun-rays"></div>
              <Sun className="text-white h-8 w-8 animate-spin" style={{ animationDuration: '30s' }} />
            </div>
          </div>
          <Table>
            <TableHeader>
        ...
        <div className="max-w-3xl mx-auto mb-16 relative">
          ...
          <div className="absolute -top-10 -right-10 w-40 h-40 opacity-20 pointer-events-none">
            <div className="absolute inset-0 sun-rays"></div>
            <div className="absolute inset-0 sun-burst"></div>
            <div className="sunshine-gradient rounded-full h-full w-full"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Fulltimer Pricing */}
            <div className="bg-white rounded-lg shadow-lg overflow-hidden border-2 border-[#F97316] relative">
              {/* Natural sun rays and glow in the background */}
              <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
                <div className="absolute inset-0 sun-rays"></div>
                <div className="absolute inset-x-0 top-1/4 bottom-0 sun-burst"></div>
              </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-1 text-sm text-red-600">
                    ...
                    <div className="relative h-5 w-5 flex items-center justify-center">
                      <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#FFDD6C] to-[#F97316] animate-spin" style={{ animationDuration: '15s' }}></div>
                      <Sun className="h-4 w-4 text-white relative z-10" />
                    </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="border-2 border-[#FEC6A1] bg-white/80 hover:shadow-lg transition-shadow relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-[#FFDD6C]/10 to-[#F97316]/10 rounded-bl-full"></div>
              <CardContent className="p-6">
                <div className="relative h-12 w-12 mx-auto mb-4">
                  <div className="absolute inset-0 sun-rays opacity-50"></div>
                  <div className="sunshine-gradient rounded-full h-full w-full flex items-center justify-center shadow-md sun-glow group-hover:scale-110 transition-transform">
            ...
            <Card className="border-2 border-[#FEC6A1] bg-white/80 hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <div className="relative h-12 w-12 mx-auto mb-4">
                  <div className="absolute inset-0 sun-rays opacity-50"></div>
                  <div className="sunshine-gradient rounded-full h-full w-full flex items-center justify-center shadow-md">
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start group hover:scale-105 transition-transform">
                <div className="relative w-10 h-10">
                  <div className="absolute inset-0 sun-rays opacity-50"></div>
                  <div className="sunshine-gradient p-2 rounded-full h-full w-full flex items-center justify-center">
        ...
        <div className="mt-12 text-center">
          <Button className="stb-button text-lg flex items-center gap-2 relative">
            <div className="absolute inset-0 sun-rays opacity-30"></div>
