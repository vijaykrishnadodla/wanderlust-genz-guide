      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-6 text-center md:text-left">
            ...
            <p className="text-lg text-[#e93546] font-handwritten md:text-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:justify-start justify-center">
              <Button className="bg-gradient-to-r from-[#fdad32] to-[#fe4c02] text-white font-bold rounded-full px-8 py-3 hover:shadow-lg hover:-translate-y-1 transition-all group">
            ...
            <div className="flex justify-center md:justify-start items-center gap-2 mt-2">
              <div className="flex -space-x-2">
                ...
                <div className="w-8 h-8 rounded-full bg-[#70d5ff] flex items-center justify-center text-xs">🌞</div>
              </div>
          ...
          <div className="relative h-[300px] md:h-[450px]">
            ...
            <div className="absolute top-10 right-10">
              <div className="bg-gradient-to-br from-[#70d5ff] to-[#1b729d] p-3 rounded-full animate-bounce-light">
            ...
            <div className="absolute top-28 left-24">
              <div className="bg-white p-3 rounded-lg shadow-sm max-w-[200px] relative">
                ...
                <p className="font-handwritten text-[#fe4c02]">"You pack the snacks, I'll plan the vibe! Ready for adventure?" ☀️</p>
              </div>
            </div>
          </div>
        </div>
