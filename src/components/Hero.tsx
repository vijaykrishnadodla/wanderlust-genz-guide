      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="relative h-[400px] md:h-[500px] flex items-center justify-center">
            ...
            {/* ISIC partner logo */}
            <div className="absolute bottom-20 right-0 z-30 bg-white rounded-lg p-2 shadow-sm transform rotate-3">
              <img src="/lovable-uploads/fce2b689-f403-4f89-9f79-0091c0c3be6f.png" alt="ISIC Partner" className="h-14 object-contain" />
            </div>
